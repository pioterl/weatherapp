...
//             LineChartBarData(
//               spots: [
//                 FlSpot(0, widget.weather!.dailyWeather[0].air_temperature),
//                 FlSpot(1, widget.weather!.dailyWeather[1].air_temperature),
//                 FlSpot(2, widget.weather!.dailyWeather[2].air_temperature),
//                 FlSpot(3, widget.weather!.dailyWeather[3].air_temperature),
//                 FlSpot(4, widget.weather!.dailyWeather[4].air_temperature),
//                 FlSpot(5, widget.weather!.dailyWeather[5].air_temperature),
//                 FlSpot(6, widget.weather!.dailyWeather[6].air_temperature),
//                 FlSpot(7, widget.weather!.dailyWeather[7].air_temperature),
//               ],
//             ),
